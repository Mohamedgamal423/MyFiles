...
//    private override init(){
//        super.init()
//        startWith(arrayOfIds: ["spt_noads_499_monthly"], sharedSecret: "a7e4732001574790acee7f3b18bfa52b")
//    }
    ...
    func purchaseProduct(success: @escaping SuccessBlock, failure: @escaping FailureBlock){
