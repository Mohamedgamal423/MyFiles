...
//        }
//    }
    @IBInspectable public var offthumbImage:UIImage? = nil
//    {
//        didSet {
//            guard let image = offthumbImage else {
//                return
//            }
//            thumbView.thumbImageView.image = image
//        }
//    }
    ...
    private var thumbView = CustomThumbView(frame: CGRect.zero)
...
extension CustomSwitch {
    ...
    public override func layoutSubviews() {
        ...
        if !self.isAnimating {
            ...
            self.backgroundColor = self.isOn ? self.onTintColor : self.offTintColor
            self.thumbView.thumbImageView.image = self.isOn ? self.thumbImage! : self.offthumbImage!
            // thumb managment
